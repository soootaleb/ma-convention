...
import MCApplication from './containers/MCApplication';
...
ReactDOM.render(<Provider store={store}><MCApplication/></Provider>, document.getElementById('root') as HTMLElement);
